...
DASH_VERSION="$(curl -s https://api.github.com/repos/nezhahq/nezha/releases | grep -m 1 -oP '"tag_name":\s*"v\K[^"]+')"

wget -q https://github.com/nezhahq/nezha/releases/download/v${DASH_VERSION}/dashboard-linux-amd64.zip
